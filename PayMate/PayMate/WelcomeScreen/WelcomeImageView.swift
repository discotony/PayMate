            ...
            GeometryReader { geometry in
                ZStack {
                    ...
                    Image(.coin)
                        ...
                        .offset(x: isMovingRight ? geometry.size.width * -0.08: geometry.size.width * -0.335, y: geometry.size.height * 0.355) // Dynamically set offset values based on screen sizes
